...
function hazze_scripts()
{
	...
	wp_enqueue_style('libre-fonts', 'https://fonts.googleapis.com/css?family=Libre+Franklin:400,500,600,700,800,900&display=swap', array(), _S_VERSION);
	...
	wp_enqueue_style('magnific', get_template_directory_uri() . '/css/magnific-popup.css', array(), _S_VERSION);
	...
	wp_enqueue_script('jquery-3.3.1', get_template_directory_uri() . '/js/jquery-3.3.1.min.js', array(), _S_VERSION, true);
